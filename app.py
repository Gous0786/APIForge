...
async def run_agent_and_collect_events(session_id, user_id, prompt):
    ...
    try:
        ...
        if code_blocks:
            formatted_result += """
            <div class="card">
               <div class="card-header">🧠 Generated Code</div>
        ...
        runner_info['result'] = formatted_result if formatted_result.strip() else "<div class='text-red-600'>⚠️ No response was generated by the agent.</div>"
...
if __name__ == '__main__':
    port = int(os.environ.get("PORT", 8080))  # ✅ Use env var
